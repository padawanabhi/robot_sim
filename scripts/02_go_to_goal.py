...
def main():
    ...
    print("Starting go-to-goal controller...")
    
    for step in range(1000):
        # Get robot state and goal
        ...
        action = controller.compute(current_pose, goal_pose, obstacles)
        
        # Step simulation
        env.step([action])  # list of actions for each robot
        env.render()
